...
This project integrates Supabase (PostgreSQL) for data storage, React for the frontend, and NBA API for player images. Users can view detailed player cards, shot 
charts, and percentile rankings for NBA players for the current season.
